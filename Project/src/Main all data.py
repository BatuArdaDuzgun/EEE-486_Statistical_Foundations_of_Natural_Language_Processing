...
f = open("all-train-stemmed.txt", 'w', encoding='utf-8', errors='replace')
...
f = open("all-test-stemmed.txt", 'w', encoding='utf-8', errors='replace')
...
f = open("all-dev-stemmed.txt", 'w', encoding='utf-8', errors='replace')
