...
f = open("en-train-stemmed.txt", 'w', encoding='utf-8', errors='replace')
...
f = open("en-test-stemmed.txt", 'w', encoding='utf-8', errors='replace')
...
f = open("en-dev-stemmed.txt", 'w', encoding='utf-8', errors='replace')
